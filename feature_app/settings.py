"""
Django settings for feature_app project.
...
SECRET_KEY = 'django-insecure-(telw=0sc4*c6l(g!j@cae0$84ki+3^&f%^e6m2=a#!n-du(3t'
...
WSGI_APPLICATION = 'feature_app.wsgi.application'
